# Manga-Colorizer (Mac Optimized)

> **Note:** This project is a revamped Mac-optimized version heavily based on the original [Manga-Colorizer by BinitDOX](https://github.com/BinitDOX/Manga-Colorizer). Huge thanks for the original codebase!
